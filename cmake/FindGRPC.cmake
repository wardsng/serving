...
# https://raw.githubusercontent.com/IvanSafonov/grpc-cmake-example/master/cmake/FindGRPC.cmake
#
...
function(GRPC_GENERATE_CPP SRCS HDRS DEST)
  ...
  foreach(FIL ${ARGN})
    ...
    list(APPEND ${SRCS} "${RESOLVED_DEST}/${FIL_WE}.grpc.pb.cc")
    list(APPEND ${HDRS} "${RESOLVED_DEST}/${FIL_WE}.grpc.pb.h")

    add_custom_command(
      OUTPUT "${RESOLVED_DEST}/${FIL_WE}.grpc.pb.cc"
             "${RESOLVED_DEST}/${FIL_WE}.grpc.pb.h"
